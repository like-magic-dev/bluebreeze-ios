...
public class BBAssignedNumbers {
    ...
    public static let serviceUUIDs: [BBUUID: String] = [
        ...
        BBUUID(string: "1801"): "GATT",
        BBUUID(string: "1802"): "Immediate Alert",
        BBUUID(string: "1803"): "Link Loss",
        BBUUID(string: "1804"): "Tx Power",
        BBUUID(string: "1805"): "Current Time",
        BBUUID(string: "1806"): "Reference Time Update",
        BBUUID(string: "1807"): "Next DST Change",
        BBUUID(string: "1808"): "Glucose",
        BBUUID(string: "1809"): "Health Thermometer",
        BBUUID(string: "180A"): "Device Information",
        BBUUID(string: "180D"): "Heart Rate",
        BBUUID(string: "180E"): "Phone Alert Status",
        BBUUID(string: "180F"): "Battery",
        BBUUID(string: "1810"): "Blood Pressure",
        BBUUID(string: "1811"): "Alert Notification",
        BBUUID(string: "1812"): "Human Interface Device",
        BBUUID(string: "1813"): "Scan Parameters",
        BBUUID(string: "1814"): "Running Speed and Cadence",
        BBUUID(string: "1815"): "Automation IO",
        BBUUID(string: "1816"): "Cycling Speed and Cadence",
        BBUUID(string: "1818"): "Cycling Power",
        BBUUID(string: "1819"): "Location and Navigation",
        BBUUID(string: "181A"): "Environmental Sensing",
        BBUUID(string: "181B"): "Body Composition",
        BBUUID(string: "181C"): "User Data",
        BBUUID(string: "181D"): "Weight Scale",
        BBUUID(string: "181E"): "Bond Management",
        BBUUID(string: "181F"): "Continuous Glucose Monitoring",
        BBUUID(string: "1820"): "Internet Protocol Support",
        BBUUID(string: "1821"): "Indoor Positioning",
        BBUUID(string: "1822"): "Pulse Oximeter",
        BBUUID(string: "1823"): "HTTP Proxy",
        BBUUID(string: "1824"): "Transport Discovery",
        BBUUID(string: "1825"): "Object Transfer",
        BBUUID(string: "1826"): "Fitness Machine",
        BBUUID(string: "1827"): "Mesh Provisioning",
        BBUUID(string: "1828"): "Mesh Proxy",
        BBUUID(string: "1829"): "Reconnection Configuration",
        BBUUID(string: "183A"): "Insulin Delivery",
        BBUUID(string: "183B"): "Binary Sensor",
        BBUUID(string: "183C"): "Emergency Configuration",
        BBUUID(string: "183D"): "Authorization Control",
        BBUUID(string: "183E"): "Physical Activity Monitor",
        BBUUID(string: "183F"): "Elapsed Time",
        BBUUID(string: "1840"): "Generic Health Sensor",
        BBUUID(string: "1843"): "Audio Input Control",
        BBUUID(string: "1844"): "Volume Control",
        BBUUID(string: "1845"): "Volume Offset Control",
        BBUUID(string: "1846"): "Coordinated Set Identification",
        BBUUID(string: "1847"): "Device Time",
        BBUUID(string: "1848"): "Media Control",
        BBUUID(string: "1849"): "Generic Media Control",
        BBUUID(string: "184A"): "Constant Tone Extension",
        BBUUID(string: "184B"): "Telephone Bearer",
        BBUUID(string: "184C"): "Generic Telephone Bearer",
        BBUUID(string: "184D"): "Microphone Control",
        BBUUID(string: "184E"): "Audio Stream Control",
        BBUUID(string: "184F"): "Broadcast Audio Scan",
        BBUUID(string: "1850"): "Published Audio Capabilities",
        BBUUID(string: "1851"): "Basic Audio Announcement",
        BBUUID(string: "1852"): "Broadcast Audio Announcement",
        BBUUID(string: "1853"): "Common Audio",
        BBUUID(string: "1854"): "Hearing Access",
        BBUUID(string: "1855"): "Telephony and Media Audio",
        BBUUID(string: "1856"): "Public Broadcast Announcement",
        BBUUID(string: "1857"): "Electronic Shelf Label",
        BBUUID(string: "1858"): "Gaming Audio",
        BBUUID(string: "1859"): "Mesh Proxy Solicitation",
        BBUUID(string: "185A"): "Industrial Measurement Device",
        BBUUID(string: "185B"): "Ranging",
        BBUUID(string: "185C"): "HID ISO",
        BBUUID(string: "185D"): "Cookware",
        BBUUID(string: "185E"): "Voice Assistant",
        BBUUID(string: "185F"): "Generic Voice Assistant",
        BBUUID(string: "1860"): "Tire Pressure Monitoring System",
    ]

    /// Bluetooth SIG characteristic UUIDs
    public static let characteristicUUIDs: [BBUUID: String] = [
        BBUUID(string: "2A00"): "Device Name",
        BBUUID(string: "2A01"): "Appearance",
        BBUUID(string: "2A02"): "Peripheral Privacy Flag",
        BBUUID(string: "2A03"): "Reconnection Address",
        BBUUID(string: "2A04"): "Peripheral Preferred Connection Parameters",
        BBUUID(string: "2A05"): "Service Changed",
        BBUUID(string: "2A06"): "Alert Level",
        BBUUID(string: "2A07"): "Tx Power Level",
        BBUUID(string: "2A08"): "Date Time",
        BBUUID(string: "2A09"): "Day of Week",
        BBUUID(string: "2A0A"): "Day Date Time",
        BBUUID(string: "2A0C"): "Exact Time 256",
        BBUUID(string: "2A0D"): "DST Offset",
        BBUUID(string: "2A0E"): "Time Zone",
        BBUUID(string: "2A0F"): "Local Time Information",
        BBUUID(string: "2A11"): "Time with DST",
        BBUUID(string: "2A12"): "Time Accuracy",
        BBUUID(string: "2A13"): "Time Source",
        BBUUID(string: "2A14"): "Reference Time Information",
        BBUUID(string: "2A16"): "Time Update Control Point",
        BBUUID(string: "2A17"): "Time Update State",
        BBUUID(string: "2A18"): "Glucose Measurement",
        BBUUID(string: "2A19"): "Battery Level",
        BBUUID(string: "2A1C"): "Temperature Measurement",
        BBUUID(string: "2A1D"): "Temperature Type",
        BBUUID(string: "2A1E"): "Intermediate Temperature",
        BBUUID(string: "2A21"): "Measurement Interval",
        BBUUID(string: "2A22"): "Boot Keyboard Input Report",
        BBUUID(string: "2A23"): "System ID",
        BBUUID(string: "2A24"): "Model Number String",
        BBUUID(string: "2A25"): "Serial Number String",
        BBUUID(string: "2A26"): "Firmware Revision String",
        BBUUID(string: "2A27"): "Hardware Revision String",
        BBUUID(string: "2A28"): "Software Revision String",
        BBUUID(string: "2A29"): "Manufacturer Name String",
        BBUUID(string: "2A2A"): "IEEE 11073-20601 Regulatory Certification Data List",
        BBUUID(string: "2A2B"): "Current Time",
        BBUUID(string: "2A2C"): "Magnetic Declination",
        BBUUID(string: "2A31"): "Scan Refresh",
        BBUUID(string: "2A32"): "Boot Keyboard Output Report",
        BBUUID(string: "2A33"): "Boot Mouse Input Report",
        BBUUID(string: "2A34"): "Glucose Measurement Context",
        BBUUID(string: "2A35"): "Blood Pressure Measurement",
        BBUUID(string: "2A36"): "Intermediate Cuff Pressure",
        BBUUID(string: "2A37"): "Heart Rate Measurement",
        BBUUID(string: "2A38"): "Body Sensor Location",
        BBUUID(string: "2A39"): "Heart Rate Control Point",
        BBUUID(string: "2A3F"): "Alert Status",
        BBUUID(string: "2A40"): "Ringer Control Point",
        BBUUID(string: "2A41"): "Ringer Setting",
        BBUUID(string: "2A42"): "Alert Category ID Bit Mask",
        BBUUID(string: "2A43"): "Alert Category ID",
        BBUUID(string: "2A44"): "Alert Notification Control Point",
        BBUUID(string: "2A45"): "Unread Alert Status",
        BBUUID(string: "2A46"): "New Alert",
        BBUUID(string: "2A47"): "Supported New Alert Category",
        BBUUID(string: "2A48"): "Supported Unread Alert Category",
        BBUUID(string: "2A49"): "Blood Pressure Feature",
        BBUUID(string: "2A4A"): "HID Information",
        BBUUID(string: "2A4B"): "Report Map",
        BBUUID(string: "2A4C"): "HID Control Point",
        BBUUID(string: "2A4D"): "Report",
        BBUUID(string: "2A4E"): "Protocol Mode",
        BBUUID(string: "2A4F"): "Scan Interval Window",
        BBUUID(string: "2A50"): "PnP ID",
        BBUUID(string: "2A51"): "Glucose Feature",
        BBUUID(string: "2A52"): "Record Access Control Point",
        BBUUID(string: "2A53"): "RSC Measurement",
        BBUUID(string: "2A54"): "RSC Feature",
        BBUUID(string: "2A55"): "SC Control Point",
        BBUUID(string: "2A5A"): "Aggregate",
        BBUUID(string: "2A5B"): "CSC Measurement",
        BBUUID(string: "2A5C"): "CSC Feature",
        BBUUID(string: "2A5D"): "Sensor Location",
        BBUUID(string: "2A5E"): "PLX Spot-Check Measurement",
        BBUUID(string: "2A5F"): "PLX Continuous Measurement",
        BBUUID(string: "2A60"): "PLX Features",
        BBUUID(string: "2A63"): "Cycling Power Measurement",
        BBUUID(string: "2A64"): "Cycling Power Vector",
        BBUUID(string: "2A65"): "Cycling Power Feature",
        BBUUID(string: "2A66"): "Cycling Power Control Point",
        BBUUID(string: "2A67"): "Location and Speed",
        BBUUID(string: "2A68"): "Navigation",
        BBUUID(string: "2A69"): "Position Quality",
        BBUUID(string: "2A6A"): "LN Feature",
        BBUUID(string: "2A6B"): "LN Control Point",
        BBUUID(string: "2A6C"): "Elevation",
        BBUUID(string: "2A6D"): "Pressure",
        BBUUID(string: "2A6E"): "Temperature",
        BBUUID(string: "2A6F"): "Humidity",
        BBUUID(string: "2A70"): "True Wind Speed",
        BBUUID(string: "2A71"): "True Wind Direction",
        BBUUID(string: "2A72"): "Apparent Wind Speed",
        BBUUID(string: "2A73"): "Apparent Wind Direction",
        BBUUID(string: "2A74"): "Gust Factor",
        BBUUID(string: "2A75"): "Pollen Concentration",
        BBUUID(string: "2A76"): "UV Index",
        BBUUID(string: "2A77"): "Irradiance",
        BBUUID(string: "2A78"): "Rainfall",
        BBUUID(string: "2A79"): "Wind Chill",
        BBUUID(string: "2A7A"): "Heat Index",
        BBUUID(string: "2A7B"): "Dew Point",
        BBUUID(string: "2A7D"): "Descriptor Value Changed",
        BBUUID(string: "2A7E"): "Aerobic Heart Rate Lower Limit",
        BBUUID(string: "2A7F"): "Aerobic Threshold",
        BBUUID(string: "2A80"): "Age",
        BBUUID(string: "2A81"): "Anaerobic Heart Rate Lower Limit",
        BBUUID(string: "2A82"): "Anaerobic Heart Rate Upper Limit",
        BBUUID(string: "2A83"): "Anaerobic Threshold",
        BBUUID(string: "2A84"): "Aerobic Heart Rate Upper Limit",
        BBUUID(string: "2A85"): "Date of Birth",
        BBUUID(string: "2A86"): "Date of Threshold Assessment",
        BBUUID(string: "2A87"): "Email Address",
        BBUUID(string: "2A88"): "Fat Burn Heart Rate Lower Limit",
        BBUUID(string: "2A89"): "Fat Burn Heart Rate Upper Limit",
        BBUUID(string: "2A8A"): "First Name",
        BBUUID(string: "2A8B"): "Five Zone Heart Rate Limits",
        BBUUID(string: "2A8C"): "Gender",
        BBUUID(string: "2A8D"): "Heart Rate Max",
        BBUUID(string: "2A8E"): "Height",
        BBUUID(string: "2A8F"): "Hip Circumference",
        BBUUID(string: "2A90"): "Last Name",
        BBUUID(string: "2A91"): "Maximum Recommended Heart Rate",
        BBUUID(string: "2A92"): "Resting Heart Rate",
        BBUUID(string: "2A93"): "Sport Type for Aerobic and Anaerobic Thresholds",
        BBUUID(string: "2A94"): "Three Zone Heart Rate Limits",
        BBUUID(string: "2A95"): "Two Zone Heart Rate Limits",
        BBUUID(string: "2A96"): "VO2 Max",
        BBUUID(string: "2A97"): "Waist Circumference",
        BBUUID(string: "2A98"): "Weight",
        BBUUID(string: "2A99"): "Database Change Increment",
        BBUUID(string: "2A9A"): "User Index",
        BBUUID(string: "2A9B"): "Body Composition Feature",
        BBUUID(string: "2A9C"): "Body Composition Measurement",
        BBUUID(string: "2A9D"): "Weight Measurement",
        BBUUID(string: "2A9E"): "Weight Scale Feature",
        BBUUID(string: "2A9F"): "User Control Point",
        BBUUID(string: "2AA0"): "Magnetic Flux Density - 2D",
        BBUUID(string: "2AA1"): "Magnetic Flux Density - 3D",
        BBUUID(string: "2AA2"): "Language",
        BBUUID(string: "2AA3"): "Barometric Pressure Trend",
        BBUUID(string: "2AA4"): "Bond Management Control Point",
        BBUUID(string: "2AA5"): "Bond Management Feature",
        BBUUID(string: "2AA6"): "Central Address Resolution",
        BBUUID(string: "2AA7"): "CGM Measurement",
        BBUUID(string: "2AA8"): "CGM Feature",
        BBUUID(string: "2AA9"): "CGM Status",
        BBUUID(string: "2AAA"): "CGM Session Start Time",
        BBUUID(string: "2AAB"): "CGM Session Run Time",
        BBUUID(string: "2AAC"): "CGM Specific Ops Control Point",
        BBUUID(string: "2AAD"): "Indoor Positioning Configuration",
        BBUUID(string: "2AAE"): "Latitude",
        BBUUID(string: "2AAF"): "Longitude",
        BBUUID(string: "2AB0"): "Local North Coordinate",
        BBUUID(string: "2AB1"): "Local East Coordinate",
        BBUUID(string: "2AB2"): "Floor Number",
        BBUUID(string: "2AB3"): "Altitude",
        BBUUID(string: "2AB4"): "Uncertainty",
        BBUUID(string: "2AB5"): "Location Name",
        BBUUID(string: "2AB6"): "URI",
        BBUUID(string: "2AB7"): "HTTP Headers",
        BBUUID(string: "2AB8"): "HTTP Status Code",
        BBUUID(string: "2AB9"): "HTTP Entity Body",
        BBUUID(string: "2ABA"): "HTTP Control Point",
        BBUUID(string: "2ABB"): "HTTPS Security",
        BBUUID(string: "2ABC"): "TDS Control Point",
        BBUUID(string: "2ABD"): "OTS Feature",
        BBUUID(string: "2ABE"): "Object Name",
        BBUUID(string: "2ABF"): "Object Type",
        BBUUID(string: "2AC0"): "Object Size",
        BBUUID(string: "2AC1"): "Object First-Created",
        BBUUID(string: "2AC2"): "Object Last-Modified",
        BBUUID(string: "2AC3"): "Object ID",
        BBUUID(string: "2AC4"): "Object Properties",
        BBUUID(string: "2AC5"): "Object Action Control Point",
        BBUUID(string: "2AC6"): "Object List Control Point",
        BBUUID(string: "2AC7"): "Object List Filter",
        BBUUID(string: "2AC8"): "Object Changed",
        BBUUID(string: "2AC9"): "Resolvable Private Address Only",
        BBUUID(string: "2ACC"): "Fitness Machine Feature",
        BBUUID(string: "2ACD"): "Treadmill Data",
        BBUUID(string: "2ACE"): "Cross Trainer Data",
        BBUUID(string: "2ACF"): "Step Climber Data",
        BBUUID(string: "2AD0"): "Stair Climber Data",
        BBUUID(string: "2AD1"): "Rower Data",
        BBUUID(string: "2AD2"): "Indoor Bike Data",
        BBUUID(string: "2AD3"): "Training Status",
        BBUUID(string: "2AD4"): "Supported Speed Range",
        BBUUID(string: "2AD5"): "Supported Inclination Range",
        BBUUID(string: "2AD6"): "Supported Resistance Level Range",
        BBUUID(string: "2AD7"): "Supported Heart Rate Range",
        BBUUID(string: "2AD8"): "Supported Power Range",
        BBUUID(string: "2AD9"): "Fitness Machine Control Point",
        BBUUID(string: "2ADA"): "Fitness Machine Status",
        BBUUID(string: "2ADB"): "Mesh Provisioning Data In",
        BBUUID(string: "2ADC"): "Mesh Provisioning Data Out",
        BBUUID(string: "2ADD"): "Mesh Proxy Data In",
        BBUUID(string: "2ADE"): "Mesh Proxy Data Out",
        BBUUID(string: "2AE0"): "Average Current",
        BBUUID(string: "2AE1"): "Average Voltage",
        BBUUID(string: "2AE2"): "Boolean",
        BBUUID(string: "2AE3"): "Chromatic Distance from Planckian",
        BBUUID(string: "2AE4"): "Chromaticity Coordinates",
        BBUUID(string: "2AE5"): "Chromaticity in CCT and Duv Values",
        BBUUID(string: "2AE6"): "Chromaticity Tolerance",
        BBUUID(string: "2AE7"): "CIE 13.3-1995 Color Rendering Index",
        BBUUID(string: "2AE8"): "Coefficient",
        BBUUID(string: "2AE9"): "Correlated Color Temperature",
        BBUUID(string: "2AEA"): "Count 16",
        BBUUID(string: "2AEB"): "Count 24",
        BBUUID(string: "2AEC"): "Country Code",
        BBUUID(string: "2AED"): "Date UTC",
        BBUUID(string: "2AEE"): "Electric Current",
        BBUUID(string: "2AEF"): "Electric Current Range",
        BBUUID(string: "2AF0"): "Electric Current Specification",
        BBUUID(string: "2AF1"): "Electric Current Statistics",
        BBUUID(string: "2AF2"): "Energy",
        BBUUID(string: "2AF3"): "Energy in a Period of Day",
        BBUUID(string: "2AF4"): "Event Statistics",
        BBUUID(string: "2AF5"): "Fixed String 16",
        BBUUID(string: "2AF6"): "Fixed String 24",
        BBUUID(string: "2AF7"): "Fixed String 36",
        BBUUID(string: "2AF8"): "Fixed String 8",
        BBUUID(string: "2AF9"): "Generic Level",
        BBUUID(string: "2AFA"): "Global Trade Item Number",
        BBUUID(string: "2AFB"): "Illuminance",
        BBUUID(string: "2AFC"): "Luminous Efficacy",
        BBUUID(string: "2AFD"): "Luminous Energy",
        BBUUID(string: "2AFE"): "Luminous Exposure",
        BBUUID(string: "2AFF"): "Luminous Flux",
        BBUUID(string: "2B00"): "Luminous Flux Range",
        BBUUID(string: "2B01"): "Luminous Intensity",
        BBUUID(string: "2B02"): "Mass Flow",
        BBUUID(string: "2B03"): "Perceived Lightness",
        BBUUID(string: "2B04"): "Percentage 8",
        BBUUID(string: "2B05"): "Power",
        BBUUID(string: "2B06"): "Power Specification",
        BBUUID(string: "2B07"): "Relative Runtime in a Current Range",
        BBUUID(string: "2B08"): "Relative Runtime in a Generic Level Range",
        BBUUID(string: "2B09"): "Relative Value in a Voltage Range",
        BBUUID(string: "2B0A"): "Relative Value in an Illuminance Range",
        BBUUID(string: "2B0B"): "Relative Value in a Period of Day",
        BBUUID(string: "2B0C"): "Relative Value in a Temperature Range",
        BBUUID(string: "2B0D"): "Temperature 8",
        BBUUID(string: "2B0E"): "Temperature 8 in a Period of Day",
        BBUUID(string: "2B0F"): "Temperature 8 Statistics",
        BBUUID(string: "2B10"): "Temperature Range",
        BBUUID(string: "2B11"): "Temperature Statistics",
        BBUUID(string: "2B12"): "Time Decihour 8",
        BBUUID(string: "2B13"): "Time Exponential 8",
        BBUUID(string: "2B14"): "Time Hour 24",
        BBUUID(string: "2B15"): "Time Millisecond 24",
        BBUUID(string: "2B16"): "Time Second 16",
        BBUUID(string: "2B17"): "Time Second 8",
        BBUUID(string: "2B18"): "Voltage",
        BBUUID(string: "2B19"): "Voltage Specification",
        BBUUID(string: "2B1A"): "Voltage Statistics",
        BBUUID(string: "2B1B"): "Volume Flow",
        BBUUID(string: "2B1C"): "Chromaticity Coordinate",
        BBUUID(string: "2B1D"): "RC Feature",
        BBUUID(string: "2B1E"): "RC Settings",
        BBUUID(string: "2B1F"): "Reconnection Configuration Control Point",
        BBUUID(string: "2B20"): "IDD Status Changed",
        BBUUID(string: "2B21"): "IDD Status",
        BBUUID(string: "2B22"): "IDD Annunciation Status",
        BBUUID(string: "2B23"): "IDD Features",
        BBUUID(string: "2B24"): "IDD Status Reader Control Point",
        BBUUID(string: "2B25"): "IDD Command Control Point",
        BBUUID(string: "2B26"): "IDD Command Data",
        BBUUID(string: "2B27"): "IDD Record Access Control Point",
        BBUUID(string: "2B28"): "IDD History Data",
        BBUUID(string: "2B29"): "Client Supported Features",
        BBUUID(string: "2B2A"): "Database Hash",
        BBUUID(string: "2B2B"): "BSS Control Point",
        BBUUID(string: "2B2C"): "BSS Response",
        BBUUID(string: "2B2D"): "Emergency ID",
        BBUUID(string: "2B2E"): "Emergency Text",
        BBUUID(string: "2B2F"): "ACS Status",
        BBUUID(string: "2B30"): "ACS Data In",
        BBUUID(string: "2B31"): "ACS Data Out Notify",
        BBUUID(string: "2B32"): "ACS Data Out Indicate",
        BBUUID(string: "2B33"): "ACS Control Point",
        BBUUID(string: "2B34"): "Enhanced Blood Pressure Measurement",
        BBUUID(string: "2B35"): "Enhanced Intermediate Cuff Pressure",
        BBUUID(string: "2B36"): "Blood Pressure Record",
        BBUUID(string: "2B37"): "Registered User",
        BBUUID(string: "2B38"): "BR-EDR Handover Data",
        BBUUID(string: "2B39"): "Bluetooth SIG Data",
        BBUUID(string: "2B3A"): "Server Supported Features",
        BBUUID(string: "2B3B"): "Physical Activity Monitor Features",
        BBUUID(string: "2B3C"): "General Activity Instantaneous Data",
        BBUUID(string: "2B3D"): "General Activity Summary Data",
        BBUUID(string: "2B3E"): "CardioRespiratory Activity Instantaneous Data",
        BBUUID(string: "2B3F"): "CardioRespiratory Activity Summary Data",
        BBUUID(string: "2B40"): "Step Counter Activity Summary Data",
        BBUUID(string: "2B41"): "Sleep Activity Instantaneous Data",
        BBUUID(string: "2B42"): "Sleep Activity Summary Data",
        BBUUID(string: "2B43"): "Physical Activity Monitor Control Point",
        BBUUID(string: "2B44"): "Physical Activity Current Session",
        BBUUID(string: "2B45"): "Physical Activity Session Descriptor",
        BBUUID(string: "2B46"): "Preferred Units",
        BBUUID(string: "2B47"): "High Resolution Height",
        BBUUID(string: "2B48"): "Middle Name",
        BBUUID(string: "2B49"): "Stride Length",
        BBUUID(string: "2B4A"): "Handedness",
        BBUUID(string: "2B4B"): "Device Wearing Position",
        BBUUID(string: "2B4C"): "Four Zone Heart Rate Limits",
        BBUUID(string: "2B4D"): "High Intensity Exercise Threshold",
        BBUUID(string: "2B4E"): "Activity Goal",
        BBUUID(string: "2B4F"): "Sedentary Interval Notification",
        BBUUID(string: "2B50"): "Caloric Intake",
        BBUUID(string: "2B51"): "TMAP Role",
        BBUUID(string: "2B77"): "Audio Input State",
        BBUUID(string: "2B78"): "Gain Settings Attribute",
        BBUUID(string: "2B79"): "Audio Input Type",
        BBUUID(string: "2B7A"): "Audio Input Status",
        BBUUID(string: "2B7B"): "Audio Input Control Point",
        BBUUID(string: "2B7C"): "Audio Input Description",
        BBUUID(string: "2B7D"): "Volume State",
        BBUUID(string: "2B7E"): "Volume Control Point",
        BBUUID(string: "2B7F"): "Volume Flags",
        BBUUID(string: "2B80"): "Volume Offset State",
        BBUUID(string: "2B81"): "Audio Location",
        BBUUID(string: "2B82"): "Volume Offset Control Point",
        BBUUID(string: "2B83"): "Audio Output Description",
        BBUUID(string: "2B84"): "Set Identity Resolving Key",
        BBUUID(string: "2B85"): "Coordinated Set Size",
        BBUUID(string: "2B86"): "Set Member Lock",
        BBUUID(string: "2B87"): "Set Member Rank",
        BBUUID(string: "2B88"): "Encrypted Data Key Material",
        BBUUID(string: "2B89"): "Apparent Energy 32",
        BBUUID(string: "2B8A"): "Apparent Power",
        BBUUID(string: "2B8B"): "Live Health Observations",
        BBUUID(string: "2B8C"): "CO2 Concentration",
        BBUUID(string: "2B8D"): "Cosine of the Angle",
        BBUUID(string: "2B8E"): "Device Time Feature",
        BBUUID(string: "2B8F"): "Device Time Parameters",
        BBUUID(string: "2B90"): "Device Time",
        BBUUID(string: "2B91"): "Device Time Control Point",
        BBUUID(string: "2B92"): "Time Change Log Data",
        BBUUID(string: "2B93"): "Media Player Name",
        BBUUID(string: "2B94"): "Media Player Icon Object ID",
        BBUUID(string: "2B95"): "Media Player Icon URL",
        BBUUID(string: "2B96"): "Track Changed",
        BBUUID(string: "2B97"): "Track Title",
        BBUUID(string: "2B98"): "Track Duration",
        BBUUID(string: "2B99"): "Track Position",
        BBUUID(string: "2B9A"): "Playback Speed",
        BBUUID(string: "2B9B"): "Seeking Speed",
        BBUUID(string: "2B9C"): "Current Track Segments Object ID",
        BBUUID(string: "2B9D"): "Current Track Object ID",
        BBUUID(string: "2B9E"): "Next Track Object ID",
        BBUUID(string: "2B9F"): "Parent Group Object ID",
        BBUUID(string: "2BA0"): "Current Group Object ID",
        BBUUID(string: "2BA1"): "Playing Order",
        BBUUID(string: "2BA2"): "Playing Orders Supported",
        BBUUID(string: "2BA3"): "Media State",
        BBUUID(string: "2BA4"): "Media Control Point",
        BBUUID(string: "2BA5"): "Media Control Point Opcodes Supported",
        BBUUID(string: "2BA6"): "Search Results Object ID",
        BBUUID(string: "2BA7"): "Search Control Point",
        BBUUID(string: "2BA8"): "Energy 32",
        BBUUID(string: "2BAD"): "Constant Tone Extension Enable",
        BBUUID(string: "2BAE"): "Advertising Constant Tone Extension Minimum Length",
        BBUUID(string: "2BAF"): "Advertising Constant Tone Extension Minimum Transmit Count",
        BBUUID(string: "2BB0"): "Advertising Constant Tone Extension Transmit Duration",
        BBUUID(string: "2BB1"): "Advertising Constant Tone Extension Interval",
        BBUUID(string: "2BB2"): "Advertising Constant Tone Extension PHY",
        BBUUID(string: "2BB3"): "Bearer Provider Name",
        BBUUID(string: "2BB4"): "Bearer UCI",
        BBUUID(string: "2BB5"): "Bearer Technology",
        BBUUID(string: "2BB6"): "Bearer URI Schemes Supported List",
        BBUUID(string: "2BB7"): "Bearer Signal Strength",
        BBUUID(string: "2BB8"): "Bearer Signal Strength Reporting Interval",
        BBUUID(string: "2BB9"): "Bearer List Current Calls",
        BBUUID(string: "2BBA"): "Content Control ID",
        BBUUID(string: "2BBB"): "Status Flags",
        BBUUID(string: "2BBC"): "Incoming Call Target Bearer URI",
        BBUUID(string: "2BBD"): "Call State",
        BBUUID(string: "2BBE"): "Call Control Point",
        BBUUID(string: "2BBF"): "Call Control Point Optional Opcodes",
        BBUUID(string: "2BC0"): "Termination Reason",
        BBUUID(string: "2BC1"): "Incoming Call",
        BBUUID(string: "2BC2"): "Call Friendly Name",
        BBUUID(string: "2BC3"): "Mute",
        BBUUID(string: "2BC4"): "Sink ASE",
        BBUUID(string: "2BC5"): "Source ASE",
        BBUUID(string: "2BC6"): "ASE Control Point",
        BBUUID(string: "2BC7"): "Broadcast Audio Scan Control Point",
        BBUUID(string: "2BC8"): "Broadcast Receive State",
        BBUUID(string: "2BC9"): "Sink PAC",
        BBUUID(string: "2BCA"): "Sink Audio Locations",
        BBUUID(string: "2BCB"): "Source PAC",
        BBUUID(string: "2BCC"): "Source Audio Locations",
        BBUUID(string: "2BCD"): "Available Audio Contexts",
        BBUUID(string: "2BCE"): "Supported Audio Contexts",
        BBUUID(string: "2BCF"): "Ammonia Concentration",
        BBUUID(string: "2BD0"): "Carbon Monoxide Concentration",
        BBUUID(string: "2BD1"): "Methane Concentration",
        BBUUID(string: "2BD2"): "Nitrogen Dioxide Concentration",
        BBUUID(string: "2BD3"): "Non-Methane Volatile Organic Compounds Concentration",
        BBUUID(string: "2BD4"): "Ozone Concentration",
        BBUUID(string: "2BD5"): "Particulate Matter - PM1 Concentration",
        BBUUID(string: "2BD6"): "Particulate Matter - PM2.5 Concentration",
        BBUUID(string: "2BD7"): "Particulate Matter - PM10 Concentration",
        BBUUID(string: "2BD8"): "Sulfur Dioxide Concentration",
        BBUUID(string: "2BD9"): "Sulfur Hexafluoride Concentration",
        BBUUID(string: "2BDA"): "Hearing Aid Features",
        BBUUID(string: "2BDB"): "Hearing Aid Preset Control Point",
        BBUUID(string: "2BDC"): "Active Preset Index",
        BBUUID(string: "2BDD"): "Stored Health Observations",
        BBUUID(string: "2BDE"): "Fixed String 64",
        BBUUID(string: "2BDF"): "High Temperature",
        BBUUID(string: "2BE0"): "High Voltage",
        BBUUID(string: "2BE1"): "Light Distribution",
        BBUUID(string: "2BE2"): "Light Output",
        BBUUID(string: "2BE3"): "Light Source Type",
        BBUUID(string: "2BE4"): "Noise",
        BBUUID(string: "2BE5"): "Relative Runtime in a Correlated Color Temperature Range",
        BBUUID(string: "2BE6"): "Time Second 32",
        BBUUID(string: "2BE7"): "VOC Concentration",
        BBUUID(string: "2BE8"): "Voltage Frequency",
        BBUUID(string: "2BE9"): "Battery Critical Status",
        BBUUID(string: "2BEA"): "Battery Health Status",
        BBUUID(string: "2BEB"): "Battery Health Information",
        BBUUID(string: "2BEC"): "Battery Information",
        BBUUID(string: "2BED"): "Battery Level Status",
        BBUUID(string: "2BEE"): "Battery Time Status",
        BBUUID(string: "2BEF"): "Estimated Service Date",
        BBUUID(string: "2BF0"): "Battery Energy Status",
        BBUUID(string: "2BF1"): "Observation Schedule Changed",
        BBUUID(string: "2BF2"): "Elapsed Time",
        BBUUID(string: "2BF3"): "Health Sensor Features",
        BBUUID(string: "2BF4"): "GHS Control Point",
        BBUUID(string: "2BF5"): "LE GATT Security Levels",
        BBUUID(string: "2BF6"): "ESL Address",
        BBUUID(string: "2BF7"): "AP Sync Key Material",
        BBUUID(string: "2BF8"): "ESL Response Key Material",
        BBUUID(string: "2BF9"): "ESL Current Absolute Time",
        BBUUID(string: "2BFA"): "ESL Display Information",
        BBUUID(string: "2BFB"): "ESL Image Information",
        BBUUID(string: "2BFC"): "ESL Sensor Information",
        BBUUID(string: "2BFD"): "ESL LED Information",
        BBUUID(string: "2BFE"): "ESL Control Point",
        BBUUID(string: "2BFF"): "UDI for Medical Devices",
        BBUUID(string: "2C00"): "GMAP Role",
        BBUUID(string: "2C01"): "UGG Features",
        BBUUID(string: "2C02"): "UGT Features",
        BBUUID(string: "2C03"): "BGS Features",
        BBUUID(string: "2C04"): "BGR Features",
        BBUUID(string: "2C05"): "Percentage 8 Steps",
        BBUUID(string: "2C06"): "Acceleration",
        BBUUID(string: "2C07"): "Force",
        BBUUID(string: "2C08"): "Linear Position",
        BBUUID(string: "2C09"): "Rotational Speed",
        BBUUID(string: "2C0A"): "Length",
        BBUUID(string: "2C0B"): "Torque",
        BBUUID(string: "2C0C"): "IMD Status",
        BBUUID(string: "2C0D"): "IMDS Descriptor Value Changed",
        BBUUID(string: "2C0E"): "First Use Date",
        BBUUID(string: "2C0F"): "Life Cycle Data",
        BBUUID(string: "2C10"): "Work Cycle Data",
        BBUUID(string: "2C11"): "Service Cycle Data",
        BBUUID(string: "2C12"): "IMD Control",
        BBUUID(string: "2C13"): "IMD Historical Data",
        BBUUID(string: "2C14"): "RAS Features",
        BBUUID(string: "2C15"): "Real-time Ranging Data",
        BBUUID(string: "2C16"): "On-demand Ranging Data",
        BBUUID(string: "2C17"): "RAS Control Point",
        BBUUID(string: "2C18"): "Ranging Data Ready",
        BBUUID(string: "2C19"): "Ranging Data Overwritten",
        BBUUID(string: "2C1A"): "Coordinated Set Name",
        BBUUID(string: "2C1B"): "Humidity 8",
        BBUUID(string: "2C1C"): "Illuminance 16",
        BBUUID(string: "2C1D"): "Acceleration - 3D",
        BBUUID(string: "2C1E"): "Precise Acceleration - 3D",
        BBUUID(string: "2C1F"): "Acceleration Detection Status",
        BBUUID(string: "2C20"): "Door/Window Status",
        BBUUID(string: "2C21"): "Pushbutton Status 8",
        BBUUID(string: "2C22"): "Contact Status 8",
        BBUUID(string: "2C23"): "HID ISO Properties",
        BBUUID(string: "2C24"): "LE HID Operation Mode",
        BBUUID(string: "2C25"): "Cookware Description",
        BBUUID(string: "2C26"): "Recipe Control",
        BBUUID(string: "2C27"): "Recipe Parameters",
        BBUUID(string: "2C28"): "Cooking Step Status",
        BBUUID(string: "2C29"): "Cooking Zone Capabilities",
        BBUUID(string: "2C2A"): "Cooking Zone Desired Cooking Conditions",
        BBUUID(string: "2C2B"): "Cooking Zone Actual Cooking Conditions",
        BBUUID(string: "2C2C"): "Cookware Sensor Data",
        BBUUID(string: "2C2D"): "Cookware Sensor Aggregate",
        BBUUID(string: "2C2E"): "Cooking Temperature",
        BBUUID(string: "2C2F"): "Cooking Zone Perceived Power",
        BBUUID(string: "2C30"): "Kitchen Appliance Airflow",
        BBUUID(string: "2C31"): "Voice Assistant Name",
        BBUUID(string: "2C32"): "Voice Assistant UUID",
        BBUUID(string: "2C33"): "Voice Assistant Service Control Point",
        BBUUID(string: "2C34"): "Installed Location",
        BBUUID(string: "2C35"): "Voice Assistant Session State",
        BBUUID(string: "2C36"): "Voice Assistant Session Flag",
        BBUUID(string: "2C37"): "Voice Assistant Supported Languages",
        BBUUID(string: "2C38"): "Voice Assistant Supported Features",
        BBUUID(string: "2C39"): "HID SCI Mode",
        BBUUID(string: "2C3A"): "HID SCI Information",
        BBUUID(string: "2C3B"): "Tire Pressure",
        BBUUID(string: "2C3C"): "Tire Temperature",
        BBUUID(string: "2C3D"): "Tire Acceleration",
        BBUUID(string: "2C3E"): "TPMS Properties",
        BBUUID(string: "2C3F"): "TPMS Duty Cycle",
        BBUUID(string: "2C40"): "TPMS Position",
        BBUUID(string: "2C41"): "TPMS Signing Key",
        BBUUID(string: "2C42"): "Cookware Device ID",
    ]

    /// Bluetooth SIG assigned company identifiers
    public static let companyIdentifiers: [UInt16: String] = [
        0x0000: "Ericsson AB",
