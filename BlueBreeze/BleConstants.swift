...
class BleConstants {
    ...
    static let knownServices: [CBUUID: String] = [
        ...
        CBUUID(string: "183A"): "Insulin Delivery",
        CBUUID(string: "183B"): "Binary Sensor",
        CBUUID(string: "183C"): "Emergency Configuration",
        CBUUID(string: "183D"): "Authorization Control",
        CBUUID(string: "183E"): "Physical Activity Monitor",
        CBUUID(string: "183F"): "Elapsed Time",
        CBUUID(string: "1840"): "Generic Health Sensor",
        CBUUID(string: "1843"): "Audio Input Control",
        CBUUID(string: "1844"): "Volume Control",
        CBUUID(string: "1845"): "Volume Offset Control",
        CBUUID(string: "1846"): "Coordinated Set Identification",
        CBUUID(string: "1847"): "Device Time",
        CBUUID(string: "1848"): "Media Control",
        CBUUID(string: "1849"): "Generic Media Control",
        CBUUID(string: "184A"): "Constant Tone Extension",
        CBUUID(string: "184B"): "Telephone Bearer",
        CBUUID(string: "184C"): "Generic Telephone Bearer",
        CBUUID(string: "184D"): "Microphone Control",
        CBUUID(string: "184E"): "Audio Stream Control",
        CBUUID(string: "184F"): "Broadcast Audio Scan",
        CBUUID(string: "1850"): "Published Audio Capabilities",
        CBUUID(string: "1851"): "Basic Audio Announcement",
        CBUUID(string: "1852"): "Broadcast Audio Announcement",
        CBUUID(string: "1853"): "Common Audio",
        CBUUID(string: "1854"): "Hearing Access",
        CBUUID(string: "1855"): "Telephony and Media Audio",
        CBUUID(string: "1856"): "Public Broadcast Announcement",
        CBUUID(string: "1857"): "Electronic Shelf Label",
        CBUUID(string: "1858"): "Gaming Audio",
        CBUUID(string: "1859"): "Mesh Proxy Solicitation"
    ]
    ...
    static let knownCharacteristics: [CBUUID: String] = [
        ...
        CBUUID(string: "2A39"): "Heart Rate Control Point",
        ...
        CBUUID(string: "2A47"): "Supported New Alert Category",
        CBUUID(string: "2A48"): "Supported Unread Alert Category",
        ...
        CBUUID(string: "2A4E"): "Protocol Mode",
        CBUUID(string: "2A4F"): "Scan Interval Window",
        CBUUID(string: "2A50"): "PnP ID",
        CBUUID(string: "2A51"): "Glucose Feature",
        CBUUID(string: "2A52"): "Record Access Control Point",
        ...
        CBUUID(string: "2A5D"): "Sensor Location",
        CBUUID(string: "2A5E"): "PLX Spot-Check Measurement",
        CBUUID(string: "2A5F"): "PLX Continuous Measurement",
        ...
        CBUUID(string: "2A67"): "Location and Speed",
        CBUUID(string: "2A68"): "Navigation",
        CBUUID(string: "2A69"): "Position Quality",
        CBUUID(string: "2A6A"): "LN Feature",
        CBUUID(string: "2A6B"): "LN Control Point",
        ...
        CBUUID(string: "2A7E"): "Aerobic Heart Rate Lower Limit",
        CBUUID(string: "2A7F"): "Aerobic Threshold",
        CBUUID(string: "2A80"): "Age",
        ...
        CBUUID(string: "2A95"): "Two Zone Heart Rate Limits",
        CBUUID(string: "2A96"): "VO2 Max",
        ...
        CBUUID(string: "2A9C"): "Body Composition Measurement",
        CBUUID(string: "2A9D"): "Weight Measurement",
        CBUUID(string: "2A9E"): "Weight Scale Feature",
        CBUUID(string: "2A9F"): "User Control Point",
        CBUUID(string: "2AA0"): "Magnetic Flux Density - 2D",
        CBUUID(string: "2AA1"): "Magnetic Flux Density - 3D",
        ...
        CBUUID(string: "2AAD"): "Indoor Positioning Configuration",
        ...
        CBUUID(string: "2AC9"): "Resolvable Private Address Only",
        CBUUID(string: "2ACC"): "Fitness Machine Feature",
        CBUUID(string: "2ACD"): "Treadmill Data",
        CBUUID(string: "2ACE"): "Cross Trainer Data",
        CBUUID(string: "2ACF"): "Step Climber Data",
        CBUUID(string: "2AD0"): "Stair Climber Data",
        CBUUID(string: "2AD1"): "Rower Data",
        CBUUID(string: "2AD2"): "Indoor Bike Data",
        CBUUID(string: "2AD3"): "Training Status",
        CBUUID(string: "2AD4"): "Supported Speed Range",
        CBUUID(string: "2AD5"): "Supported Inclination Range",
        CBUUID(string: "2AD6"): "Supported Resistance Level Range",
        CBUUID(string: "2AD7"): "Supported Heart Rate Range",
        ...
        CBUUID(string: "2ADB"): "Mesh Provisioning Data In",
        CBUUID(string: "2ADC"): "Mesh Provisioning Data Out",
        CBUUID(string: "2ADD"): "Mesh Proxy Data In",
        CBUUID(string: "2ADE"): "Mesh Proxy Data Out",
        CBUUID(string: "2AE0"): "Average Current",
        CBUUID(string: "2AE1"): "Average Voltage",
        CBUUID(string: "2AE2"): "Boolean",
        CBUUID(string: "2AE3"): "Chromatic Distance from Planckian",
        CBUUID(string: "2AE4"): "Chromaticity Coordinates",
        CBUUID(string: "2AE5"): "Chromaticity in CCT and Duv Values",
        CBUUID(string: "2AE6"): "Chromaticity Tolerance",
        CBUUID(string: "2AE7"): "CIE 13.3-1995 Color Rendering Index",
        CBUUID(string: "2AE8"): "Coefficient",
        CBUUID(string: "2AE9"): "Correlated Color Temperature",
        CBUUID(string: "2AEA"): "Count 16",
        CBUUID(string: "2AEB"): "Count 24",
        CBUUID(string: "2AEC"): "Country Code",
        CBUUID(string: "2AED"): "Date UTC",
        CBUUID(string: "2AEE"): "Electric Current",
        CBUUID(string: "2AEF"): "Electric Current Range",
        CBUUID(string: "2AF0"): "Electric Current Specification",
        CBUUID(string: "2AF1"): "Electric Current Statistics",
        CBUUID(string: "2AF2"): "Energy",
        CBUUID(string: "2AF3"): "Energy in a Period of Day",
        CBUUID(string: "2AF4"): "Event Statistics",
        CBUUID(string: "2AF5"): "Fixed String 16",
        CBUUID(string: "2AF6"): "Fixed String 24",
        CBUUID(string: "2AF7"): "Fixed String 36",
        CBUUID(string: "2AF8"): "Fixed String 8",
        CBUUID(string: "2AF9"): "Generic Level",
        CBUUID(string: "2AFA"): "Global Trade Item Number",
        CBUUID(string: "2AFB"): "Illuminance",
        CBUUID(string: "2AFC"): "Luminous Efficacy",
        CBUUID(string: "2AFD"): "Luminous Energy",
        CBUUID(string: "2AFE"): "Luminous Exposure",
        CBUUID(string: "2AFF"): "Luminous Flux",
        CBUUID(string: "2B00"): "Luminous Flux Range",
        CBUUID(string: "2B01"): "Luminous Intensity",
        CBUUID(string: "2B02"): "Mass Flow",
        CBUUID(string: "2B03"): "Perceived Lightness",
        CBUUID(string: "2B04"): "Percentage 8",
        CBUUID(string: "2B05"): "Power",
        CBUUID(string: "2B06"): "Power Specification",
        CBUUID(string: "2B07"): "Relative Runtime in a Current Range",
        CBUUID(string: "2B08"): "Relative Runtime in a Generic Level Range",
        CBUUID(string: "2B09"): "Relative Value in a Voltage Range",
        CBUUID(string: "2B0A"): "Relative Value in an Illuminance Range",
        CBUUID(string: "2B0B"): "Relative Value in a Period of Day",
        CBUUID(string: "2B0C"): "Relative Value in a Temperature Range",
        CBUUID(string: "2B0D"): "Temperature 8",
        CBUUID(string: "2B0E"): "Temperature 8 in a Period of Day",
        CBUUID(string: "2B0F"): "Temperature 8 Statistics",
        CBUUID(string: "2B10"): "Temperature Range",
        CBUUID(string: "2B11"): "Temperature Statistics",
        CBUUID(string: "2B12"): "Time Decihour 8",
        CBUUID(string: "2B13"): "Time Exponential 8",
        CBUUID(string: "2B14"): "Time Hour 24",
        CBUUID(string: "2B15"): "Time Millisecond 24",
        CBUUID(string: "2B16"): "Time Second 16",
        CBUUID(string: "2B17"): "Time Second 8",
        CBUUID(string: "2B18"): "Voltage",
        CBUUID(string: "2B19"): "Voltage Specification",
        CBUUID(string: "2B1A"): "Voltage Statistics",
        CBUUID(string: "2B1B"): "Volume Flow",
        CBUUID(string: "2B1C"): "Chromaticity Coordinate",
        CBUUID(string: "2B1D"): "RC Feature",
        CBUUID(string: "2B1E"): "RC Settings",
        CBUUID(string: "2B1F"): "Reconnection Configuration Control Point",
        CBUUID(string: "2B20"): "IDD Status Changed",
        CBUUID(string: "2B21"): "IDD Status",
        CBUUID(string: "2B22"): "IDD Annunciation Status",
        CBUUID(string: "2B23"): "IDD Features",
        CBUUID(string: "2B24"): "IDD Status Reader Control Point",
        CBUUID(string: "2B25"): "IDD Command Control Point",
        CBUUID(string: "2B26"): "IDD Command Data",
        CBUUID(string: "2B27"): "IDD Record Access Control Point",
        CBUUID(string: "2B28"): "IDD History Data",
        CBUUID(string: "2B29"): "Client Supported Features",
        CBUUID(string: "2B2A"): "Database Hash",
        CBUUID(string: "2B2B"): "BSS Control Point",
        CBUUID(string: "2B2C"): "BSS Response",
        CBUUID(string: "2B2D"): "Emergency ID",
        CBUUID(string: "2B2E"): "Emergency Text",
        CBUUID(string: "2B2F"): "ACS Status",
        CBUUID(string: "2B30"): "ACS Data In",
        CBUUID(string: "2B31"): "ACS Data Out Notify",
        CBUUID(string: "2B32"): "ACS Data Out Indicate",
        CBUUID(string: "2B33"): "ACS Control Point",
        CBUUID(string: "2B34"): "Enhanced Blood Pressure Measurement",
        CBUUID(string: "2B35"): "Enhanced Intermediate Cuff Pressure",
        CBUUID(string: "2B36"): "Blood Pressure Record",
        CBUUID(string: "2B37"): "Registered User",
        CBUUID(string: "2B38"): "BR-EDR Handover Data",
        CBUUID(string: "2B39"): "Bluetooth SIG Data",
        CBUUID(string: "2B3A"): "Server Supported Features",
        CBUUID(string: "2B3B"): "Physical Activity Monitor Features",
        CBUUID(string: "2B3C"): "General Activity Instantaneous Data",
        CBUUID(string: "2B3D"): "General Activity Summary Data",
        CBUUID(string: "2B3E"): "CardioRespiratory Activity Instantaneous Data",
        CBUUID(string: "2B3F"): "CardioRespiratory Activity Summary Data",
        CBUUID(string: "2B40"): "Step Counter Activity Summary Data",
        CBUUID(string: "2B41"): "Sleep Activity Instantaneous Data",
        CBUUID(string: "2B42"): "Sleep Activity Summary Data",
        CBUUID(string: "2B43"): "Physical Activity Monitor Control Point",
        CBUUID(string: "2B44"): "Physical Activity Current Session",
        CBUUID(string: "2B45"): "Physical Activity Session Descriptor",
        CBUUID(string: "2B46"): "Preferred Units",
        CBUUID(string: "2B47"): "High Resolution Height",
        CBUUID(string: "2B48"): "Middle Name",
        CBUUID(string: "2B49"): "Stride Length",
        CBUUID(string: "2B4A"): "Handedness",
        CBUUID(string: "2B4B"): "Device Wearing Position",
        CBUUID(string: "2B4C"): "Four Zone Heart Rate Limits",
        CBUUID(string: "2B4D"): "High Intensity Exercise Threshold",
        CBUUID(string: "2B4E"): "Activity Goal",
        CBUUID(string: "2B4F"): "Sedentary Interval Notification",
        CBUUID(string: "2B50"): "Caloric Intake",
        CBUUID(string: "2B51"): "TMAP Role",
        CBUUID(string: "2B77"): "Audio Input State",
        CBUUID(string: "2B78"): "Gain Settings Attribute",
        CBUUID(string: "2B79"): "Audio Input Type",
        CBUUID(string: "2B7A"): "Audio Input Status",
        CBUUID(string: "2B7B"): "Audio Input Control Point",
        CBUUID(string: "2B7C"): "Audio Input Description",
        CBUUID(string: "2B7D"): "Volume State",
        CBUUID(string: "2B7E"): "Volume Control Point",
        CBUUID(string: "2B7F"): "Volume Flags",
        CBUUID(string: "2B80"): "Volume Offset State",
        CBUUID(string: "2B81"): "Audio Location",
        CBUUID(string: "2B82"): "Volume Offset Control Point",
        CBUUID(string: "2B83"): "Audio Output Description",
        CBUUID(string: "2B84"): "Set Identity Resolving Key",
        CBUUID(string: "2B85"): "Coordinated Set Size",
        CBUUID(string: "2B86"): "Set Member Lock",
        CBUUID(string: "2B87"): "Set Member Rank",
        CBUUID(string: "2B88"): "Encrypted Data Key Material",
        CBUUID(string: "2B89"): "Apparent Energy 32",
        CBUUID(string: "2B8A"): "Apparent Power",
        CBUUID(string: "2B8B"): "Live Health Observations",
        CBUUID(string: "2B8C"): "CO2 Concentration",
        CBUUID(string: "2B8D"): "Cosine of the Angle",
        CBUUID(string: "2B8E"): "Device Time Feature",
        CBUUID(string: "2B8F"): "Device Time Parameters",
        CBUUID(string: "2B90"): "Device Time",
        CBUUID(string: "2B91"): "Device Time Control Point",
        CBUUID(string: "2B92"): "Time Change Log Data",
        CBUUID(string: "2B93"): "Media Player Name",
        CBUUID(string: "2B94"): "Media Player Icon Object ID",
        CBUUID(string: "2B95"): "Media Player Icon URL",
        CBUUID(string: "2B96"): "Track Changed",
        CBUUID(string: "2B97"): "Track Title",
        CBUUID(string: "2B98"): "Track Duration",
        CBUUID(string: "2B99"): "Track Position",
        CBUUID(string: "2B9A"): "Playback Speed",
        CBUUID(string: "2B9B"): "Seeking Speed",
        CBUUID(string: "2B9C"): "Current Track Segments Object ID",
        CBUUID(string: "2B9D"): "Current Track Object ID",
        CBUUID(string: "2B9E"): "Next Track Object ID",
        CBUUID(string: "2B9F"): "Parent Group Object ID",
        CBUUID(string: "2BA0"): "Current Group Object ID",
        CBUUID(string: "2BA1"): "Playing Order",
        CBUUID(string: "2BA2"): "Playing Orders Supported",
        CBUUID(string: "2BA3"): "Media State",
        CBUUID(string: "2BA4"): "Media Control Point",
        CBUUID(string: "2BA5"): "Media Control Point Opcodes Supported",
        CBUUID(string: "2BA6"): "Search Results Object ID",
        CBUUID(string: "2BA7"): "Search Control Point",
        CBUUID(string: "2BA8"): "Energy 32",
        CBUUID(string: "2BAD"): "Constant Tone Extension Enable",
        CBUUID(string: "2BAE"): "Advertising Constant Tone Extension Minimum Length",
        CBUUID(string: "2BAF"): "Advertising Constant Tone Extension Minimum Transmit Count",
        CBUUID(string: "2BB0"): "Advertising Constant Tone Extension Transmit Duration",
        CBUUID(string: "2BB1"): "Advertising Constant Tone Extension Interval",
        CBUUID(string: "2BB2"): "Advertising Constant Tone Extension PHY",
        CBUUID(string: "2BB3"): "Bearer Provider Name",
        CBUUID(string: "2BB4"): "Bearer UCI",
        CBUUID(string: "2BB5"): "Bearer Technology",
        CBUUID(string: "2BB6"): "Bearer URI Schemes Supported List",
        CBUUID(string: "2BB7"): "Bearer Signal Strength",
        CBUUID(string: "2BB8"): "Bearer Signal Strength Reporting Interval",
        CBUUID(string: "2BB9"): "Bearer List Current Calls",
        CBUUID(string: "2BBA"): "Content Control ID",
        CBUUID(string: "2BBB"): "Status Flags",
        CBUUID(string: "2BBC"): "Incoming Call Target Bearer URI",
        CBUUID(string: "2BBD"): "Call State",
        CBUUID(string: "2BBE"): "Call Control Point",
        CBUUID(string: "2BBF"): "Call Control Point Optional Opcodes",
        CBUUID(string: "2BC0"): "Termination Reason",
        CBUUID(string: "2BC1"): "Incoming Call",
        CBUUID(string: "2BC2"): "Call Friendly Name",
        CBUUID(string: "2BC3"): "Mute",
        CBUUID(string: "2BC4"): "Sink ASE",
        CBUUID(string: "2BC5"): "Source ASE",
        CBUUID(string: "2BC6"): "ASE Control Point",
        CBUUID(string: "2BC7"): "Broadcast Audio Scan Control Point",
        CBUUID(string: "2BC8"): "Broadcast Receive State",
        CBUUID(string: "2BC9"): "Sink PAC",
        CBUUID(string: "2BCA"): "Sink Audio Locations",
        CBUUID(string: "2BCB"): "Source PAC",
        CBUUID(string: "2BCC"): "Source Audio Locations",
        CBUUID(string: "2BCD"): "Available Audio Contexts",
        CBUUID(string: "2BCE"): "Supported Audio Contexts",
        CBUUID(string: "2BCF"): "Ammonia Concentration",
        CBUUID(string: "2BD0"): "Carbon Monoxide Concentration",
        CBUUID(string: "2BD1"): "Methane Concentration",
        CBUUID(string: "2BD2"): "Nitrogen Dioxide Concentration",
        CBUUID(string: "2BD3"): "Non-Methane Volatile Organic Compounds Concentration",
        CBUUID(string: "2BD4"): "Ozone Concentration",
        CBUUID(string: "2BD5"): "Particulate Matter - PM1 Concentration",
        CBUUID(string: "2BD6"): "Particulate Matter - PM2.5 Concentration",
        CBUUID(string: "2BD7"): "Particulate Matter - PM10 Concentration",
        CBUUID(string: "2BD8"): "Sulfur Dioxide Concentration",
        CBUUID(string: "2BD9"): "Sulfur Hexafluoride Concentration",
        CBUUID(string: "2BDA"): "Hearing Aid Features",
        CBUUID(string: "2BDB"): "Hearing Aid Preset Control Point",
        CBUUID(string: "2BDC"): "Active Preset Index",
        CBUUID(string: "2BDD"): "Stored Health Observations",
        CBUUID(string: "2BDE"): "Fixed String 64",
        CBUUID(string: "2BDF"): "High Temperature",
        CBUUID(string: "2BE0"): "High Voltage",
        CBUUID(string: "2BE1"): "Light Distribution",
        CBUUID(string: "2BE2"): "Light Output",
        CBUUID(string: "2BE3"): "Light Source Type",
        CBUUID(string: "2BE4"): "Noise",
        CBUUID(string: "2BE5"): "Relative Runtime in a Correlated Color Temperature Range",
        CBUUID(string: "2BE6"): "Time Second 32",
        CBUUID(string: "2BE7"): "VOC Concentration",
        CBUUID(string: "2BE8"): "Voltage Frequency",
        CBUUID(string: "2BE9"): "Battery Critical Status",
        CBUUID(string: "2BEA"): "Battery Health Status",
        CBUUID(string: "2BEB"): "Battery Health Information",
        CBUUID(string: "2BEC"): "Battery Information",
        CBUUID(string: "2BED"): "Battery Level Status",
        CBUUID(string: "2BEE"): "Battery Time Status",
        CBUUID(string: "2BEF"): "Estimated Service Date",
        CBUUID(string: "2BF0"): "Battery Energy Status",
        CBUUID(string: "2BF1"): "Observation Schedule Changed",
        CBUUID(string: "2BF2"): "Current Elapsed Time",
        CBUUID(string: "2BF3"): "Health Sensor Features",
        CBUUID(string: "2BF4"): "GHS Control Point",
        CBUUID(string: "2BF5"): "LE GATT Security Levels",
        CBUUID(string: "2BF6"): "ESL Address",
        CBUUID(string: "2BF7"): "AP Sync Key Material",
        CBUUID(string: "2BF8"): "ESL Response Key Material",
        CBUUID(string: "2BF9"): "ESL Current Absolute Time",
        CBUUID(string: "2BFA"): "ESL Display Information",
        CBUUID(string: "2BFB"): "ESL Image Information",
        CBUUID(string: "2BFC"): "ESL Sensor Information",
        CBUUID(string: "2BFD"): "ESL LED Information",
        CBUUID(string: "2BFE"): "ESL Control Point",
        CBUUID(string: "2BFF"): "UDI for Medical Devices",
        CBUUID(string: "2C00"): "GMAP Role",
        CBUUID(string: "2C01"): "UGG Features",
        CBUUID(string: "2C02"): "UGT Features",
        CBUUID(string: "2C03"): "BGS Features",
        CBUUID(string: "2C04"): "BGR Features",
        CBUUID(string: "2C05"): "Percentage 8 Steps",
    ]
